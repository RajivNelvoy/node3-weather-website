...
// const url = 'https://api.weatherstack.com/current?access_key=b25ae876c16334e45c1573438c593918&query=38.95,-77.35'
// const httpRequest = request({url: url, json: true}, (error, response) => {
